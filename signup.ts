...
const regMail = document.getElementById("reg-email") as HTMLInputElement;
const regPass = document.getElementById("reg-pass") as HTMLInputElement;
const regConfirmedPass = document.getElementById(
  "reg-confirmPass"
) as HTMLInputElement;
const regBtn = document.getElementById("reg-btn") as HTMLButtonElement;
const errorDiv = document.getElementById("signup-errors") as HTMLElement;
...
regBtn.addEventListener("click", (e) => {
  ...
  if (!regName.value) errors.push("Full name is required.");

  if (!isValid(regMail.value)) errors.push("Invalid email format.");
  ...
  const inputs = document.querySelectorAll<HTMLInputElement>(
    "#reg-name, #reg-email, #reg-pass, #reg-confirmPass"
  );
